...
class ExplanationOutput:
    ...
    correction_suggestions: Optional[List[str]] = None
    ...
    proposed_repair_query: Optional[str] = None
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "proposed_repair_query": self.proposed_repair_query,
        }
    ...
    def from_dict(cls, data: Dict):
        ...
        return cls(
            ...
            proposed_repair_query=data.get("proposed_repair_query"),
        )