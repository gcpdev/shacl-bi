...
class TestFlaskApp:
    ...
    def test_app_has_blueprints(self, app):
        ...
        expected_blueprints = [
            'simple', 'analytics', 'dashboard', 'homepage',
            'landing', 'main_content', 'phoenix', 'shape_view',
            'shapes_overview', 'upload', 'validation'
        ]
        ...
        assert len(found_blueprints) >= 7, f"Too few blueprints found. Expected at least 7, found {len(found_blueprints)}. Registered: {registered_blueprints}"
