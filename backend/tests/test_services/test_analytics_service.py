...
class TestAnalyticsService:
    ...
    def test_get_violation_statistics(self, mock_virtuoso):
        ...
        mock_virtuoso.execute_sparql_query.return_value = {
            "results": {
                "bindings": [
                    {
                        "constraintType": {"value": "MinCountConstraintComponent"},
                        "count": {"value": "15"},
                    },
                    {
                        "constraintType": {"value": "MaxCountConstraintComponent"},
                        "count": {"value": "8"},
                    },
                    {
                        "constraintType": {"value": "PatternConstraintComponent"},
                        "count": {"value": "12"},
                    },
                ]
            }
    ...
    def test_get_property_distribution(self, mock_virtuoso):
        ...
        mock_virtuoso.execute_sparql_query.return_value = {
            "results": {
                "bindings": [
                    {
                        "property": {"value": "http://example.org/ns#name"},
                        "violationCount": {"value": "5"},
                    },
                    {
                        "property": {"value": "http://example.org/ns#email"},
    ...
    def test_get_shape_complexity_metrics(self, mock_virtuoso):
        ...
        mock_virtuoso.execute_sparql_query.return_value = {
            "results": {
                "bindings": [
                    {
                        "shape": {"value": "http://example.org/shapes/PersonShape"},
                        "constraintCount": {"value": "4"},
                    },
                    {
                        "shape": {
                            "value": "http://example.org/shapes/OrganizationShape"
                        },
    ...
    def test_get_focus_node_analysis(self, mock_virtuoso):
        ...
        mock_virtuoso.execute_sparql_query.return_value = {
            "results": {
                "bindings": [
                    {
                        "focusNode": {"value": "http://example.org/person1"},
                        "violationCount": {"value": "3"},
                    },
                    {
                        "focusNode": {"value": "http://example.org/person2"},
                        "violationCount": {"value": "2"},
                    },
                ]
            }
        }
    ...
    def test_get_data_quality_score(self, mock_virtuoso):
        ...
        assert (
            quality_score["qualityScore"] >= 0 and quality_score["qualityScore"] <= 100
        )
    ...
    def test_get_constraint_correlation_matrix(self, mock_virtuoso):
        ...
        mock_virtuoso.execute_sparql_query.return_value = {
            "results": {
                "bindings": [
                    {
                        "constraint1": {"value": "MinCountConstraintComponent"},
                        "constraint2": {"value": "MaxCountConstraintComponent"},
                        "correlation": {"value": "0.3"},
                    },
                    {
                        "constraint1": {"value": "MinCountConstraintComponent"},
                        "constraint2": {"value": "PatternConstraintComponent"},
        ...
        assert (
            float(matrix[0]["correlation"]) >= -1
            and float(matrix[0]["correlation"]) <= 1
        )
    ...
    def test_get_session_comparison(self, mock_virtuoso):
        ...
        mock_virtuoso.execute_sparql_query.return_value = {
            "results": {
                "bindings": [
                    {
                        "sessionId": {"value": "session_1"},
                        "violationCount": {"value": "10"},
                        "qualityScore": {"value": "85.5"},
                    },
                    {
                        "sessionId": {"value": "session_2"},
                        "violationCount": {"value": "15"},
                        "qualityScore": {"value": "78.2"},
                    },
                ]
            }
        }

        comparison = analytics_service.get_session_comparison(
            ["session_1", "session_2"]
        )
    ...
    def test_get_top_violating_resources(self, mock_virtuoso):
        ...
        top_resources = analytics_service.get_top_violating_resources(
            "session_123", limit=10
        )
                ...
                "bindings": [
                    {
                        ...
                        "duration": {"value": "1250"},
                        "triplesValidated": {"value": "500"},
                    },
                    {
                        "validationId": {"value": "val_2"},
                        "duration": {"value": "2100"},
                        "triplesValidated": {"value": "800"},
                    },
                ]
            }
        }
    ...
    def test_calculate_trend_direction(self):
        ...
        assert (
            analytics_service.calculate_trend_direction(increasing_data) == "increasing"
        )

        # Test decreasing trend
        decreasing_data = [5, 4, 3, 2, 1]
        assert (
            analytics_service.calculate_trend_direction(decreasing_data) == "decreasing"
        )
        ...
        short_data = [1, 2]
        assert (
            analytics_service.calculate_trend_direction(short_data)
            == "insufficient_data"
        )
    ...
    def test_get_recommendations(self, mock_virtuoso):
        ...
        recommendations = analytics_service.get_improvement_recommendations(
            "session_123"
        )
