                ...
                "bindings": [
                    {
                        ...
                        "createdAt": {"value": "2023-01-01T10:00:00"},
                        "status": {"value": "completed"},
                    },
                    {
                        "sessionId": {"value": "session_124"},
                        "createdAt": {"value": "2023-01-01T11:00:00"},
    ...
    def test_get_recent_errors(self, mock_virtuoso):
        ...
        mock_virtuoso.execute_sparql_query.return_value = {
            "results": {
                "bindings": [
                    {
                        "errorId": {"value": "error_1"},
                        "message": {"value": "Database connection failed"},
                        "timestamp": {"value": "2023-01-01T10:30:00"},
                        "severity": {"value": "high"},
                    },
                    {
                        "errorId": {"value": "error_2"},
                        "message": {"value": "Invalid SPARQL syntax"},
                        "timestamp": {"value": "2023-01-01T11:15:00"},
                ...
                "bindings": [
                    {
                        ...
                        "avgValidationTime": {"value": "2.5"},
                        "totalValidations": {"value": "10"},
                    },
                    {
                        "date": {"value": "2023-01-02"},
                        "avgValidationTime": {"value": "2.1"},
                        "totalValidations": {"value": "15"},
                    },
                ]
            }
        }
                ...
                "bindings": [
                    {
                        "validationId": {"value": "val_1"},
                        "sessionId": {"value": "session_123"},
                        "startTime": {"value": "2023-01-01T10:00:00"},
                        "endTime": {"value": "2023-01-01T10:02:30"},
                        "status": {"value": "completed"},
                        "violationsFound": {"value": "5"},
                    },
                    {
                        "validationId": {"value": "val_2"},
                        "sessionId": {"value": "session_124"},
                        "startTime": {"value": "2023-01-01T11:00:00"},
                        "endTime": {"value": "2023-01-01T11:01:45"},
                        "status": {"value": "completed"},
                        "violationsFound": {"value": "12"},
                    },
                ]
            }
        }
